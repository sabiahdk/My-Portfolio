...
const Skills = () => {
  return (
    <div className="border-b-cyan-900  flex w-[20%] max-md:flex-col   ">
      <div className=" border text-white bg-[#2B3140] max-md:w-100 ">
        <div>
        ...
        <div>
          <div className=" shadow-2xl  py-10 px-10 m-6 max-md:w-[300px]  ">
      ...
      <div className="m-3 bg-[#2B3140] text-white border max-md: w-72  ">
        <h1 className="font-bold text-2xl">EDUCATION</h1>
        <div className="w-60  py-9 px-8 m-3">
          <h1 className="font-bold">Primary and Secondary</h1>
          <p>Nrul-HAQ nursery and primary school-2005-2012</p>
          <p>Saint Paul Comprehensive College - 2012-2018</p>
        </div>

        <div className="w-60 shadow-2xl py-9 px-8 m-3 ">
